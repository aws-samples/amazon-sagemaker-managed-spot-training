...
def train(batch_size, epochs, learning_rate, num_gpus, training_channel, testing_channel,
    ...
    if not os.listdir(args.checkpoint_path):
        ...
        mlp_model, initial_epoch_number = load_model_from_checkpoints(args.checkpoint_path)
    
    logging.info("Starting training from epoch: {}".format(initial_epoch_number))
    ...
    mlp_model.fit(train_iter,
                  ...
                  num_epoch=epochs,
                  begin_epoch=initial_epoch_number)
...
if __name__ == '__main__':
    ...
    train(args.batch_size, args.epochs, args.learning_rate, num_gpus, args.train, args.test,
          args.hosts, args.current_host, args.model_dir, args.checkpoint_path)
